...
namespace CommandTerminal
{
    ...
    public class Terminal : MonoBehaviour
    {
        ...
        IFn eval;
        IFn read;
        //can't set *ns* with eval! so arcadia.repl keeps track of the *ns* binding
        ...
        void Start() {
            ...
            // prn_str = RT.var("clojure.core", "prn-str");
            // eval = RT.var("clojure.core", "eval");
            // read = RT.var("clojure.core", "read-string");
            // repl_rfn = RT.var("arcadia.repl", "repl-eval-print");
            // map = (IPersistentMap) RT.var("arcadia.repl", "env-map").invoke();
        ...
        void EnterCommand() {
            ...
            //1st attempt: no success with in-ns
            //string txt = (string) prn_str.invoke(eval.invoke(read.invoke(command_text)));
            //2nd attempt
